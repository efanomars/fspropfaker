...
# File:   install_fspropfaker-all.py
...
def main():
	...
	print("== install libfspropfaker ======" + sInfo + "==")
	os.chdir("libfspropfaker/scripts")
	subprocess.check_call("./install_libfspropfaker.py {} {} {} {} {} {} {} {} {} {} {}".format(\
