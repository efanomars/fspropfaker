...
# File:   uninstall_fspropfaker-all.py

# Removes all files installed by the install_fspropfaker-all.py script.
...
def main():
	import argparse
	oParser = argparse.ArgumentParser("Removes all files created by install_fspropfaker-all.py")
	...
	subprocess.check_call("./libfspropfaker/scripts/uninstall_libfspropfaker.py -y {} {}"
						" --installdir {}  {}"\
