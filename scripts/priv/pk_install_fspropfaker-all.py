...
# File:   pk_install_fspropfaker-all.py
...
# In addition to the install_fspropfaker-all.py parameters it sets the STMM_DEBIAN_PACKAGING
...
def main():
	import argparse
	oParser = argparse.ArgumentParser(description="Install all fspropfaker projects.\n"
						"  Same as install_fspropfaker-all.py but sets STMM_DEBIAN_PACKAGING environment variable\n"
						"  to ON."
	...
	subprocess.check_call("./install_fspropfaker-all.py {} {} {} {} {} {} {} {} {} {} {}".format(\
